@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            {!! __('shop::app.emails.orders.canceled.greeting', [
                ...
                'created_at' => core()->formatDate($order->created_at, 'm/d/Y h:i:s A')
                ])
            !!}
        </p>
    </div>
    ...
    @include ('shop::emails.orders.parts.order_address', ['order' => $order])
    @include ('shop::emails.orders.parts.payments', ['order' => $order])
    @include ('shop::emails.orders.parts.shipping', ['order' => $order, 'shipment' =>  null])
        ...
        border-spacing: 0;width: 100%">
            <thead>
                <tr style="color: #121A26;border-top: 1px solid #CBD5E1;border-bottom: 1px solid #CBD5E1;">
                    ...
                    <th style="text-align: left;padding: 5px">@lang('shop::app.emails.orders.price')</th>
                    <th style="text-align: left;padding: 5px">@lang('shop::app.emails.orders.qty')</th>
                </tr>
            </thead>
