@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('shop::app.emails.orders.refunded.greeting', [
                ...
                'created_at' => core()->formatDate($refund->order->created_at, 'm/d/Y h:i:s A')
            ])
        </p>
    </div>
    ...
    @include ('shop::emails.orders.parts.order_address', ['order' => $refund->order])
    @include ('shop::emails.orders.parts.payments', ['order' => $refund->order])
    @include ('shop::emails.orders.parts.shipping', ['order' => $refund->order, 'shipment' =>  null])
