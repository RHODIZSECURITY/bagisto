@component('admin::emails.layout')
    ...
    @include ('admin::emails.orders.parts.order_address', ['order' => $order])
    @include ('admin::emails.orders.parts.payments', ['order' => $order])
    @include ('admin::emails.orders.parts.shipping', ['order' => $order, 'shipment' =>  null])
