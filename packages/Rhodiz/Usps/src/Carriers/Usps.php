...
namespace Rhodiz\Usps\Carriers;

use Webkul\Shipping\Carriers\AbstractShipping;
use Webkul\Checkout\Models\CartShippingRate;
use Rhodiz\Usps\Helpers\ShippingMethodHelper;
use Rhodiz\Usps\Repositories\UspsRepository;
...
class Usps extends AbstractShipping
{
    ...
    public function calculate()
    {
        ...
        array_push($shippingMethods, $this->getRate2());
        array_push($shippingMethods, $this->getRate3());
     ...
     * Get rate.
     */
    public function getRate2(): CartShippingRate
    {
        $cartShippingRate = new CartShippingRate;

        $cartShippingRate->carrier = $this->getCode();
        $cartShippingRate->carrier_title = $this->getConfigData('title')."_2222";
        $cartShippingRate->method = $this->getMethod()."2222";
        $cartShippingRate->method_title = $this->getConfigData('title')."_2222";
        $cartShippingRate->method_description = $this->getConfigData('description');
        $cartShippingRate->price = 20;
        $cartShippingRate->base_price = 20;
     ...
     * Get rate.
     */
    public function getRate3(): CartShippingRate
    {
        $cartShippingRate = new CartShippingRate;

        $cartShippingRate->carrier = $this->getCode();
        $cartShippingRate->carrier_title = $this->getConfigData('title')."_3333";
        $cartShippingRate->method = $this->getMethod()."3333";
        $cartShippingRate->method_title = $this->getConfigData('title')."_3333";
        $cartShippingRate->method_description = $this->getConfigData('description'). "fff cccxcxc dsdsdsds ewewewe   ytytytt  uyuyuyuyu  fdfdfdfd";
        $cartShippingRate->price = 20;
        $cartShippingRate->base_price = 20;
