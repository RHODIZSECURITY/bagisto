...
use Rhodiz\Usps\Repositories\UspsRepository as UspsRepository;
    ...
    */
    ...
    protected function _createSoapClient()
    {
        ...
        if ('DEVELOPMENT' ==  core()->getConfigData('sales.carriers.usps.mode')) {
            $gatewayUrl = 'https://secure.shippingapis.com/ShippingAPITest.dll';
        } else {
